...
const API_KEY = process.env.NEXT_PUBLIC_KEY_THREE

const Technology = ({handelSearch, handleClick,search, breakingNews,sportsNews}:HomeProps) => {
...
export async function getStaticProps() {
  try{const breakingResponse = await fetch(`https://gnews.io/api/v4/top-headlines?token=${API_KEY}&lang=en&topic=technology`);
